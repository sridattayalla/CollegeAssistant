...
/**
 * Created by HP-PC on 28-01-2018.
 */

public class student_credits extends Fragment {
    Activity context;
    student_marksInterface bh;
    ...
    class getsem1Marks extends AsyncTask<String,String,List>{
        ...
        protected List doInBackground(String... strings) {
            try {
                ...
                String jntuno = sf.getString("id", null);
    ...
    public interface student_marksInterface{
        void marksrefresh();
    }
    ...
    public void onAttach(Activity activity) {
        ...
        bh=(student_marksInterface) activity;
    }
